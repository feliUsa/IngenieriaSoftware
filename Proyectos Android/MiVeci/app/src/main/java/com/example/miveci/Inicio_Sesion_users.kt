...
class Inicio_Sesion_users : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_inicio_sesion_users)
        movimientoBurbujas()
    }
    fun iniciaSesionUser(view: View) {
        val intent = Intent(this, MainActivity_users::class.java)
        startActivity(intent)
    }

    fun trasladoPaginaTenderos(view: View){
        val intent = Intent(this, Inicio_Sesion_Tenderos::class.java)
        startActivity(intent)
    }
